...
+ [Search-R1: Training LLMs to Reason and Leverage Search Engines with Reinforcement Learning](https://arxiv.org/abs/2503.09516) (Mar.2025)
  ...
  add search query into template, call llm iteratly to implement multi-turn search. reward model is exact string matching (rule-based outcome reward to avoid reward hacking). 
