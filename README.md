...
1. [Deep Research (Overview)](#deep-research-overview)  
2. [Search Engine Integration · API vs Browser](#search-engine-api-vs-browser)  
3. [Tool Use · Extended Functionalities](#tool-use-extended-functionalities)  
4. [Multimodal Processing & Generation](#multimodal-processing--generation)  
...
6. [Tuning · Optimizing Generalization](#tuning-optimizing-generalization)  
7. [Industrial Applications](#industrial-applications)  
8. [Benchmarks for DR Agents](#benchmarks-for-dr-agents)  
9. [Challenges & Future Directions](#challenges--future-directions)
