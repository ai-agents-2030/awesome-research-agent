...
+ [SWE-bench: Can Language Models Resolve Real-World GitHub Issues?](https://arxiv.org/abs/2310.06770) (Oct.2023)**  
  (https://github.com/SWE-bench/SWE-bench) [GitHub Repo](https://github.com/SWE-bench/SWE-bench)
  [![GitHub Stars](https://img.shields.io/github/stars/SWE-bench/SWE-bench?style=social)]
